...
<head>
    ...
    <link
        rel="icon"
        type="image/x-icon"
        href="https://d3i4yxtzktqr9n.cloudfront.net/uber-sites/99c4bc580c8b57b7.ico" />
    <title>Uber</title>
</head>
...
<body>
            ...
            <nav>
                ...
                <div>
                    <ul id="nav-links" class="nav-links">
                        ...
                        <li>
                            <a
                                href="C:\Users\dell\Documents\Clone-Uber-main-master\Clone-Uber-main-master\login-page-in-html-with-css-code\login-page-in-html-with-css-code\index.html">Log in</a>
                        </li>
            ...
            <div class="split">
                <div class="main__cta__rectangle bg-light">
                    ...
                    <div class="main__cta__text">
                        <h1>Hit the road and earn money</h1>
                        <p class="sous-titre">
                            Join the platform that gives you access to the largest network
                            of active passengers.
                        </p>
                        <a href="#" class="btn">Sign up to become a driver</a>
                        <a href="#" class="text-cta">Learn more about rides and deliveries</a>
                    </div>
                </div>
                <div></div>
            </div>
    ...
    <section id="business-header">
        <div class="container">
            <div class="business-header__text">
                ...
                <p>Change the way your employees move and dine.</p>
            ...
            <div class="split">
                ...
                <div class="engagements__section__flex">
                    <img
                        ...
                        alt="" />
                    <h4>We move over 10,000 cities</h4>
                    <p class="sous-titre">
            ...
            <div class="split">
                ...
                <div class="infos__section__card">
                    <img
                        ...
                        alt="" />
                    <p class="titre">Global Citizens</p>
                    <p class="sous-titre">
    ...
    <section id="applications__section">
        <div class="container">
            <h3>Find even more features in our apps</h3>
            <div class="split">
                <a data-aos="fade-right" href="#" class="app__card">
                    <span>Uber</span>
                    <p class="app__titre">Download the app for drivers and couriers</p>
                </a>
                <a data-aos="fade-left" href="#" class="app__card">
                    <span>Uber</span>
                    <p class="app__titre">Download the Uber app</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-dark">
        <div class="container">
            <nav>
                <div><a href="#" class="logo">KpryKorn</a></div>
                <div>
